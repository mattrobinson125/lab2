...
> There are a great number of unusually recored weapons. It makes sense that most fatal shootings would occur with the victim holding out a gun. 
...
> Great visualization that shows the amount of victims not flee. Again, how do you 'categorize' unknown and still leave 'other'.
...
> This was not my expected number or circumstance of how the victim was killed.
...
#### Random Linear Model of Upcoming Fatal Police Shootings (this is such a bad graph, we are not using this)
